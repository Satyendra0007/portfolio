...
export default function Footer() {
  return (
    <footer className="pt-5">
      <div className="flex justify-center items-center gap-10 py-4 md:py-2 bg-red-100">
        <div className="bg-white/80 p-3 md:p-2.5 rounded-full shadow-xl hover:bg-red-100 cursor-pointer ">
