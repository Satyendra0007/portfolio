  ...
  return (
    <>
      <header className="sticky top-2 bg-transparent z-10 w-full  ">
        <div className=" mx-auto flex justify-between items-center px-5 py-4 bg-red-100/50 shadow-xl rounded-full  backdrop-blur-sm md:py-3 w-[90%] md:max-w-6xl">
        ...
        <div
          id="menu"
          className="absolute top-0 -left-72  bg-red-100/80 w-52 h-screen border shadow-xl transition-all duration-700 ease-in-out md:hidden"
        >
