...
const data = [
  {
    url: hl,
    name: "Happy Living",
    desc: "This is a MERN app which has user end and admin end user can select room book hostel room online and admin can manage users, messages, rooms and recived payments",
